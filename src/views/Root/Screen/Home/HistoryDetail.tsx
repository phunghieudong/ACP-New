...
const HistoryDetailScreen: FC<BiddingTicketProps> = ({ navigation,
  route: {
    params: { FullName, Price, Quantity, BiddingName, BiddingSessionName, Thumbnail, Id, Created },
  },
}) => {
  return (
    <View style={styles.container}>
      ...
      <View style={{ marginTop: 6, marginHorizontal: 20 }}>
        <Text style={{ fontSize: 20, color: '#000000', fontWeight: "600" }}>Chi tiết phiên gói thầu {BiddingName}</Text>
      ...
      <View style={{ flexDirection: 'column', marginHorizontal: 20, paddingTop: 15 }}>
        <View style={{ flexDirection: 'row', justifyContent: "space-between", }}>
          <Text style={{ fontSize: 14, color: "#999999" }}>Tên nhà cung cấp</Text>
          <Text style={{ fontSize: 14, color: '#000000', fontWeight: "600" }}>{FullName}</Text>
        </View>
        <View style={{ flexDirection: 'row', justifyContent: "space-between", }}>
          <Text style={{ fontSize: 14, color: "#999999" }}>Số phiên</Text>
          <Text style={{ fontSize: 14, color: '#000000', fontWeight: "600" }}>{BiddingSessionName}</Text>
        </View>
        <View style={{ flexDirection: 'row', justifyContent: "space-between", }}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: "space-between", }}>
          ...
          <Text style={{ fontSize: 14, color: '#000000', fontWeight: "600" }}>{Price}</Text>
        </View>
      </View>
